...
function TeamFollowUp() {
    ...
    useEffect(() => {
            if (filterDateRange.startDate && filterDateRange.endDate) {
                fetchFollowUpData(filterDateRange.startDate, filterDateRange.endDate);
            }
        }, [filterDateRange]);

    const fetchFollowUpData = async (startDate, endDate) => {
            setLoading(true);
            const data = { startDate, endDate };
            try {
                const response = await msmartAxios.post(`/api/msmart/manager/get/followup/${teamId}`, data, {
        ...
        const handleDateChange = (selectedDates) => {
            if (selectedDates.length === 2) {
              ...
              fetchFollowUpData(formattedStartDate, formattedEndDate);
            }
          };
    const getNameInTeam = (username) => {
          ...
          const allRows = lead.flatMap((innerArray) => innerArray);

          // filter ikut nama dalam team
          const filteredRows = allRows.filter((item) => {
            const memberName = getNameInTeam(item.username).toLowerCase();
    ...
    <div class="card text-center mt-4">
      ...
      <div class="card-header text-start">
        ...
        <li class="nav-item">
         ...
         <div className="row my-3 mb-4 g-3">
          ...
          {/* Select Date */}
              ...
              <div className="col-md-6">
                <div className="form-floating">
                  ...
                  />
                  <label htmlFor="searchMember" style={{color: 'grey'}}>Search by Member's Name</label>
                </div>
              </div>
              </div>
