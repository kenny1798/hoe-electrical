...
function TeamStatSummary() {
    ...
    const [filterDate, setFilterDate] = useState([new Date(), new Date()]);
      ...
      useEffect(() => {
        setLoading(true);
        msmartAxios.get(`/api/msmart/manager/get/team/member/${teamId}`, {
            headers: {
                accessToken: user.token
            }
        }).then((response) => {
      ...
      const fetchData = async ({ startDate, endDate }) => {
        setLoading(true);
        try {
          const response = await msmartAxios.post(`/api/msmart/stats/manager/${teamId}`, { startDate: startDate, endOfDate: endDate }, {
      ...
      console.log('individual',IndividualSummary)
      ...
      return (
          ...
          <div>
            ...
            <div className="row justify-content-center">
                                        ...
                                        <nav class="nav nav-pills nav-justified my-4" style={{border: "1px solid #e9ecef", borderRadius: "40px"}}>
                                        {section === 'Team' ? <>
                                          <button type="button" class="nav-link" style={{border: "1px solid #0d6efd ", borderRadius: "40px", color: "#0d6efd"}} disabled>Team</button>
                                          <button type="button" class="nav-link" onClick={handleSection} style={{color: 'grey'}}>Individual</button>
                                          </> : <>
                                          <button type="button" class="nav-link" onClick={handleSection} style={{color: 'grey'}}>Team</button>
                                          <button type="button" class="nav-link" style={{border: "1px solid #0d6efd ", borderRadius: "40px", color: "#0d6efd"}} disabled >Individual</button>
                                          </>}
                                      </nav>
                                        </div>
                                      </div>
                              ...
                              <div className='container'>
                                  ...
                                  {loading ? (
                                    ...
                                    section === 'Team' ? (
                                      ...
                                      <div className="col-lg-12 form-floating  text-start">
                                            <Flatpickr
                                              id="floatingInput1"
...
export default TeamStatSummary