...
import ManagerViewSubmissionsModal from "./ManagerViewSubmissionsModal";
import EditLeadFormModal from "../EditLeadFormModal";


function ManagerLeadFormBuilder() {
      ...
      <div class="card text-center mt-4">
                <div class="card-header text-start">
                  ...
                  <li class="nav-item">
                      <Link
                        className="nav-link"
                        to={`/msmart/manager/database/${teamId}`}
                      >
                        Database
                      </Link>
                    </li>
...
export default ManagerLeadFormBuilder;