                          ...
                          <div class="card text-center mt-4">
                            ...
                            <div class="card-header text-start">
                              <ul class="nav nav-tabs card-header-tabs">
                                ...
                                <li class="nav-item">
                                <Link className="nav-link" to={`/msmart/manager/followup/${teamId}`}>Follow Up</Link>
                                </li>
                                <li class="nav-item">
                              ...
                              <div className='container'>
                                  ...
                                  <div className="row">
                                      ...
                                      <div className="col text-start">
                                        {summary && <>
                                        <label ></label>
                                      <div className="d-grid"><button data-bs-toggle="modal" data-bs-target="#setSalesTarget" className="btn btn-md btn-success">
                                        <i class="bi bi-gear"></i> Set Targeted Sales
                                    </button></div>
                                    </>}          
                                        </div>
                                  </div>
...
export default ManagerStatSummary